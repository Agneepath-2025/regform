...
3. A participant is limited to competing in a **maximum of 2 matches**\-1 singles and 1 doubles (one participant cannot play 2 singles).

**Semi-Finals and Finals Format:**

1. Each match will follow a **best-of-3** frames format.  
2. Teams compete in **2 singles** matches and **2 doubles** matches.  
3. A participant can compete in a maximum of 2 frames out of which maximum 1 frame can be singles matches.

**Rules:**

1. Standard 8-ball Pool rules apply.    
